...
var useLayoutEffect2 = (globalThis == null ? void 0 : globalThis.document) ? React10.useLayoutEffect : () => {
};
...
function useSize(element) {
  const [size2, setSize] = React13.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime10.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime10.jsx)(Combination_default, { as: Slot2, allowPinchZoom: true, children: (0, import_jsx_runtime10.jsx)(
          FocusScope,
          {
            asChild: true,
